...
lhgdialog.modelDialog = {
    ...
    show: function (width, height, title, src) {
        ...
        inntHtml += '<div id="maskTop" style="width: ' + width + 'px; height: ' + height + 'px; border: #999999 1px solid; background: #fff; color: #333; position: fixed; top: 50%; left: 50%; margin-left: -' + marginLeft + 'px; margin-top: -' + marginTop + 'px; z-index: 2999; filter: progid:DXImageTransform.Microsoft.Shadow(color=#909090,direction=120,strength=4); -moz-box-shadow: 2px 2px 10px #909090; -webkit-box-shadow: 2px 2px 10px #909090; box-shadow: 2px 2px 10px #909090;-webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px;">'
        inntHtml += '<div id="maskTitle" style="height: 50px; line-height: 50px; font-family: Microsoft Yahei; font-size: 20px; color: #333333; padding-left: 20px; background:#f5f5f5; border-bottom: 1px solid #999999; position: relative;border-top-left-radius: 5px;border-top-right-radius: 5px;">'
        inntHtml += '' + title + ''
        inntHtml += '<div id="popWinClose" title="关闭窗口" style="width: 21px; height: 21px; cursor: pointer; position: absolute; top: 15px; right: 15px; background: url(/Content/images/close.png) no-repeat;"></div>'
        inntHtml += '</div>'
    ...
    mouseClose: function () {
        ...
        function () {
            $(this).css("background-image", "url(/Content/images/close.png)");
        });
